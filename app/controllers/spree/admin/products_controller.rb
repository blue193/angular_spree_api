# # Changes: LineItemOptionType / LineItemOptionValue
  ...
  module Admin
    class ProductsController < ResourceController
      ...
      def update
        ...
        if params[:product][:line_item_option_type_ids].present?
          params[:product][:line_item_option_type_ids] = params[:product][:line_item_option_type_ids].split(',')
        end
      ...
      # add: line_item_option_types
      def load_data
        @taxons = Taxon.order(:name)
        @option_types = OptionType.order(:name)
        @line_item_option_types = LineItemOptionType.order(:name)
