...
ActiveRecord::Schema.define(version: 20171212185814) do
  ...
  create_table "spree_line_item_detail_records", force: :cascade do |t|
    t.integer  "position"
    t.integer  "line_item_id"
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
  ...
  add_index "spree_line_item_detail_records", ["line_item_id"], name: "index_spree_line_item_detail_records_on_line_item_id"
  add_index "spree_line_item_detail_records", ["position"], name: "index_spree_line_item_detail_records_on_position"

  create_table "spree_line_item_option_types", force: :cascade do |t|
  ...
  add_index "spree_line_item_option_types", ["name"], name: "index_spree_line_item_option_types_on_name"
  add_index "spree_line_item_option_types", ["position"], name: "index_spree_line_item_option_types_on_position"

  create_table "spree_line_item_option_value_detail_record_documents", force: :cascade do |t|
    t.integer  "line_item_option_value_detail_record_id"
    t.string   "name"
  ...
  create_table "spree_line_item_option_value_detail_records", force: :cascade do |t|
    t.integer  "line_item_detail_record_id"
    t.integer  "line_item_option_value_id"
    t.string   "text"
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
  end
  ...
  create_table "spree_line_item_option_values", force: :cascade do |t|
    ...
    t.integer  "position"
    t.integer  "line_item_option_type_id"
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
  end

  add_index "spree_line_item_option_values", ["line_item_option_type_id"], name: "index_spree_li_option_values_on_li_option_type_id"
  add_index "spree_line_item_option_values", ["name"], name: "index_spree_line_item_option_values_on_name"
  add_index "spree_line_item_option_values", ["position"], name: "index_spree_line_item_option_values_on_position"
  ...
  create_table "spree_product_line_item_option_types", force: :cascade do |t|
    t.integer  "position"
  ...
  add_index "spree_product_line_item_option_types", ["product_id"], name: "index_spree_product_line_item_option_types_on_product_id"
